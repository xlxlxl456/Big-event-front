...
import {articleCategoryListService,articleListService,articleAddService} from '@/api/article'
        ...
        <el-table :data="articles" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
                <template #default="{ row }">
                    <el-button :icon="Edit" circle plain type="primary" @click="showArticleDetail(row)"></el-button>
        ...
        <el-drawer v-model="visibleDrawer" title="添加文章" direction="rtl" size="50%">
            ...
            <el-form :model="articleModel" label-width="100px" >
              ...
              >
                ...
                <el-form-item>
                    <el-button type="primary" @click="addArticle('Released')">发布</el-button>
